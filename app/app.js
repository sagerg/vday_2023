...
var start = function() {
    ...
    let sage_green = "#9CAF88";
    let pink = "#FF1493";

    var flower_obj_1 = new Flower();
    var flower_obj_2 = new Flower();
    flower_obj_1.init().setSize(50).setPetalSize(56).setColor(sage_green).setPetal(8).setPile(2,1.2).setAlpha(0.5).create(200,200);
    flower_obj_2.init().setSize(10).setPetalSize(56).setColor(sage_green).setPetal(8).setPile(3,1.2).setAlpha(0.5).create(200,200);
    ...
    flowerrnd_obj_1.init().setSize(50).setPetalSize(56).setColor(pink).setPetal(8).setPile(2,1.2).setNoise(1.0).setAlpha(0.5).create(400,200);
    flowerrnd_obj_2.init().setSize(10).setPetalSize(56).setColor(pink).setPetal(8).setPile(3,1.2).setNoise(1.0).setAlpha(0.5).create(400,200);

    stage.addChild(flowerrnd_obj_1.flower);
    stage.addChild(flowerrnd_obj_2.flower);

    var flower3_obj_1 = new FlowerRnd();
    var flower3_obj_2 = new FlowerRnd();
    flower3_obj_1.init().setSize(50).setPetalSize(56).setColor(sage_green).setPetal(8).setPile(2,1.2).setNoise(1.0).setAlpha(0.5).create(600,200);
    flower3_obj_2.init().setSize(10).setPetalSize(56).setColor(sage_green).setPetal(8).setPile(3,1.2).setNoise(1.0).setAlpha(0.5).create(600,200);

    stage.addChild(flower3_obj_1.flower);
    stage.addChild(flower3_obj_2.flower);
    ...
    var flower3_obj_1_tween = createjs.Tween.get(flower3_obj_1.flower)
    .to({rotation:360,x:600,y:300},1000)
    .to({x:600,y:200,petal_index:0,petal_scale_0:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_1:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_2:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_3:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_4:1.3},300,createjs.Ease.cubicOut)
    ...
    var flower3_obj_2_tween = createjs.Tween.get(flower3_obj_2.flower)
    .to({rotation:360,x:600,y:300},1000)
    .to({x:600,y:200,petal_index:0,petal_scale_0:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_1:1.3},300,createjs.Ease.cubicOut)
    .to({petal_scale_2:1.3},300,createjs.Ease.cubicOut)
    ...
    timeline.addTween(flower_1_tween, flower_2_tween,flowerrnd_1_tween, flowerrnd_2_tween, flower3_obj_1_tween, flower3_obj_2_tween);
